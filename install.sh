...
wget -qO /usr/bin/menu "https://raw.githubusercontent.com/faiqzuhry/Faiq-zuhry/main/menu" && chmod 755 /usr/bin/menu
...
wget -qO /usr/bin/ganti_domain "https://raw.githubusercontent.com/faiqzuhry/Faiq-zuhry/main/ganti_domain" && chmod 755 /usr/bin/ganti_domain
